...
$headingText = $normalizeText($heading ?? 'Permintaan Tidak Valid', 'Permintaan Tidak Valid');
$messageText = $normalizeText(
  $message ?? 'Permintaan tidak dapat diproses. Silakan periksa input atau coba lagi.',
  'Permintaan tidak dapat diproses. Silakan periksa input atau coba lagi.'
);
?>
<!doctype html>
<html lang="id">
  ...
  <div class="auth-choose">
    <div class="auth-grid">
      <section class="card auth-card">
        <div class="auth-avatar">400</div>
        <div class="chip-wrap"><span class="chip">Kode Galat 400</span></div>
