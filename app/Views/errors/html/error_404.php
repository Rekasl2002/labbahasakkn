...
$displayMessage = ENVIRONMENT !== 'production' ? $message : lang('Errors.sorryCannotFind');
$meta = ENVIRONMENT !== 'production'
    ? 'Environment: ' . ENVIRONMENT . ' | ' . date('Y-m-d H:i:s')
    : null;
    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            color: var(--ink);
            background:
                radial-gradient(1200px 600px at 0% 0%, var(--bg-1), transparent),
        ...
        .badge {
            ...
            color: #fff;
            background: linear-gradient(120deg, var(--accent), #7fb1ff);
...
<main class="page">
    <section class="card">
        ...
        <p class="message"><?= nl2br((string) esc($displayMessage)) ?></p>
        <?php if ($meta) : ?>
