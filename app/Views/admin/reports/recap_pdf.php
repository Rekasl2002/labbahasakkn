...
<head>
  <meta charset="utf-8">
  <title>Laporan Rekap Sesi</title>
  <style>
    @page { margin: 18px; }
    body { font-family: DejaVu Sans, Arial, sans-serif; font-size: 11px; color: #1b1d22; }
    h1 { margin: 0 0 10px; font-size: 18px; }
    table { border-collapse: collapse; width: 100%; }
    th, td { border: 1px solid #5b6472; padding: 5px 7px; text-align: left; vertical-align: top; }
  ...
  <table>
    <thead>
      <tr>
        ...
        <th style="width:90px;">Komputer</th>
        <th style="width:90px;">IP</th>
        <th style="width:125px;">Waktu Masuk</th>
        <th style="width:125px;">Terakhir Aktif</th>
      </tr>
    </thead>
    <tbody>
